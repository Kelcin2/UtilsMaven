...
public class XSSFSheetXMLHandlerPlus extends DefaultHandler {
    private static final Logger LOG = LogManager.getLogger(XSSFSheetXMLHandlerPlus.class);
    ...
    public void startElement(String uri, String localName, String qName,
        ...
        if (isTextTag(localName)) {
            ...
            if (this.nextDataType == XSSFSheetXMLHandlerPlus.xssfDataType.NUMBER) {
                this.nextDataType = XSSFSheetXMLHandlerPlus.xssfDataType.FORMULA;
            }
            ...
            switch (nextDataType) {
                ...
                case NUMBER:
                    ...
                    if (this.formatString != null && n.length() > 0)
                        thisStr = this.formatRawCellContents(Double.parseDouble(n), this.formatIndex, this.formatString);
                    else
                        thisStr = n;
                    break;
